...
public class Snake{
	...
	/***
	 * Sets the default velocity of the snake and adds the initial snake body components to the snake body
	 */
	public Snake() {
	...
	/***
	 * Checks if the game is over and if the snake has eaten an apple. 
	 * Afterwards, updates the new location of the snake components
	 */
	public void tick() {
