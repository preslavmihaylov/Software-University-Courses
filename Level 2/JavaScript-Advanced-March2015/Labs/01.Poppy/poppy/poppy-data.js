...
(function (poppy) {
    ...
    var Popups = (function () {
        ...
        var Success = function(title, message) {
            ...
            Popup.call(this, title, message, 'success', 'bottomLeft', false, 0, false, undefined);
        }
        ...
        var Error = function (title, message) {
            ...
            Popup.call(this, title, message, 'error', 'topRight', true, ERROR_TIMEOUT, false, undefined);
        }
