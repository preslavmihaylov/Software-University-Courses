...
var Shapes = (function () {
    ...
    var Rectangle = Shape.extends({
        ...
        draw: function(canvas) {
            ...
            context.fillRect(this.coords.x, this.coords.y, this.width, this.height);
        },
        toString: function () {
    ...
    var Triangle = Shape.extends({
        ...
        draw: function (canvas) {
            ...
            context.fillStyle = this.color;
            context.beginPath();
            context.moveTo(this.coordsA.x, this.coordsA.y);
            context.lineTo(this.coordsB.x, this.coordsB.y);
            context.lineTo(this.coordsC.x, this.coordsC.y);
            context.closePath();
            context.fill();
        },
        toString: function () {
...
var rect = Object.create(Shapes.Rectangle)
    .constructor(Object.create(Point).constructor(1, 2), 50, 60, "red");

var circle = Object.create(Shapes.Circle)
    .constructor(Object.create(Point).constructor(100, 100), 25, "yellow");

var triangle = Object.create(Shapes.Triangle)
    .constructor(Object.create(Point).constructor(200, 200),
                 Object.create(Point).constructor(300, 300),
                 Object.create(Point).constructor(100, 500),
                 "green");

var line = Object.create(Shapes.Line)
    .constructor(Object.create(Point).constructor(100, 200),
                 Object.create(Point).constructor(500, 200),
                 "black");
